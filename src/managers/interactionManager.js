...
const { postMatchResult } = require("../modules/salesforceDataReader.js");
...
async function processInteraction(interaction)
{
    ...
    //     let allGeneratedTeams = applicationCache.get(APPLICATION_CACHE_KEYS.GENERATED_TEAMS);
    ...
    //     let generatedTeamObject = applicationCache.get(APPLICATION_CACHE_KEYS.GENERATED_TEAMS).get(messageId);
